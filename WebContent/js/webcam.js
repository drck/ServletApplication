...
var Webcam = {
	...
	userMedia: false, // true when getUserMedia is supported natively
	...
	attach: function(elem) {
		...
		// flash fallback
		console.log("Creo objeto para agregar elemento al div de la camara");
	...
	dispatch: function() {
		...
		if (this.hooks[name] && this.hooks[name].length) {
			...
			if ((args[0] instanceof FlashError) || (args[0] instanceof WebcamError)) {
				...
				message = "No se puede acceder a la camara del dispositivo: " + err.name + ": " + 
	...
	getSWFHTML: function() {
		...
		console.log("Recuperando SWF" + swfURL);
		...
		if (!this.detectFlash()) {
			...
			console.log('Flash Detectado');
		}
		
		// set default swfURL if not explicitly set
		if (!swfURL) {
			console.log('busco el archivo swf');
		...
		if (window.localStorage && !localStorage.getItem('visited')) {
			console.log( 'Envio panel de configuracion');
		...
		html += '<object type="application/x-shockwave-flash" data="'+swfURL+'" width="550" height="400">'+
		...
		<param name="allowFullScreen" value="false" /><param name="movie" value="'+swfURL+'" />
		...
		<embed id="webcam_movie_embed" src="'+swfURL+'" wmode="opaque" 
			loop="false" menu="false" quality="best" bgcolor="#ffffff" 
				width="'+this.params.width+'" height="'+this.params.height+'"
					name="webcam_movie_embed" align="middle" allowScriptAccess="always"
